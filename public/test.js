...
PDFs.push(pdf.output("output/lineGraph.pdf", 
...
PDFs.push(pdf.output("output/table.pdf", 
...
setTimeout(function () { pdf.concat(PDFs, "output/concatted.pdf"); }, 5000);
